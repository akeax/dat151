...
instance Print Def where
  prt i e = case e of
   DInl def -> prPrec i 0 (concatD [doc (showString "inline") , prt 0 def])
   DProt type' id args -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString "(") , prt 0 args , doc (showString ")") , doc (showString ";")])
   DFun type' id args stmts -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString "(") , prt 0 args , doc (showString ")") , doc (showString "{") , prt 0 stmts , doc (showString "}")])
...
instance Print Var where
  prt i e = case e of
   VConst var -> prPrec i 0 (concatD [doc (showString "const") , prt 0 var])
   VDecl type' id -> prPrec i 0 (concatD [prt 0 type' , prt 0 id])
   VDecls type' id ids -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString ",") , prt 0 ids])
   VInit type' id expr -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString "=") , prt 0 expr])
